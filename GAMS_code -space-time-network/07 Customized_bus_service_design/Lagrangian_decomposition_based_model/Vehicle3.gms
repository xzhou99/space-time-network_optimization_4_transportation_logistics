...
set p passenger /9*21/;
set p_h(p) physical passenger /9*20/;
...
9. 12. 37   1,        9. 12. 38   1,        9. 12. 39   1,        9. 12. 40   1,        9. 12. 41   1
...
16. 22. 39   1,        16. 22. 40   1,        16. 22. 41   1,        16. 22. 42   1,        16. 22. 43   1
...
origin_node('1','13','35') = 1;

parameter destination_node(k_h,i,t);
destination_node('1','25','60') = 1;
